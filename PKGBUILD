...
pkgver=5.10.16.xps9570.1
pkgrel=1
pkgdesc='Linux XPS9570'
_srcver=${pkgver%.*}
_srctag=v${_srcver%.*}-${_srcver##*.}-${pkgver##*.}
url="https://gitlab.marcet.info/javier/linux/-/tags/$_srctag"
arch=(x86_64)
license=(GPL2)
makedepends=(
  bc kmod libelf
...
_srcname=$pkgbase
source=(
  "$_srcname::git+ssh://git@gitlab.marcet.info:55055/javier/linux.git#tag=$_srctag"
...
sha256sums=('SKIP'
            '357858244f4c2534a51b6ecb37e3f5edcc4a2f1bde8c9be381b54d5adaeeaaf1')
